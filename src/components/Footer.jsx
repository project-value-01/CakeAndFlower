...
const Footer = () => {
  return (
    <div className="w-full bg-green-800 object-center relative">
      ...
      <div className="px-4 space-y-5 py-5 text-[13px] grid sm:grid-cols-2 w-full md:grid-cols-3 lg:grid-cols-4 lg:place-items-center sm:text-[14px] md:text-[16px] lg:text-[17px] place-items-baseline justify-start">
        <div>
          <h1 className="text-xl text-white font-semibold uppercase">
            Quick Links
          </h1>
          <ul className="text-white space-y-2 font-thin cursor-pointer">
      ...
      <div className="w-full p-2 flex justify-between items-center bg-green-950">
        <p className="text-gray-400 text-[11px] sm:text-[14px] md:text-[16px] lg:text-[18px]">
          © 2024 Project-Value All Rights Reserved.
        </p>
        <div className="text-white text-xs text-right sm:text-[14px] md:text-[16px] lg:text-[18px]">
          <p>
            Designed & Developed By :
            <a
              href="https://github.com/project-value-01/CakeAndFlower"
